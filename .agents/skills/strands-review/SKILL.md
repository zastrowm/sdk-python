...
- You MUST read API bar raising guidelines from `site/team/API_BAR_RAISING.md`
...
- You MUST evaluate the API against SDK tenets (`site/team/TENETS.md`) and decision records (`site/team/DECISIONS.md`)
